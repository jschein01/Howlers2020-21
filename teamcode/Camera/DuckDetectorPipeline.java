...
public class DuckDetectorPipeline extends OpenCvPipeline {
    ...
    static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(5, 80); //left
    static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(90, 80); // center
    static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(180, 80); // right
