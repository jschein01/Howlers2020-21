...
public class RedPipeline extends OpenCvPipeline {
    ...
    static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(50, 80); //left
    static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(150, 80); // center
    static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(240, 80); // right
